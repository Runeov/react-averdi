...
import { SametingetHub } from './SametingetHub';

export function Kunnskapsbank() {
  const [activeTab, setActiveTab] = useState<'hub' | 'sametinget'>('hub');

  if (activeTab === 'sametinget') {
    return <SametingetHub onBack={() => setActiveTab('hub')} />;
  }
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Vi deler vår kompetanse for å hjelpe din bedrift å vokse. Her finner du guider, nyheter og nyttige verktøy.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-[#E86C1F]/10 relative group hover:border-[#E86C1F]/30 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 gap-8 p-8 md:p-12 items-center">
              <div className="space-y-6">
                ...
                <button 
                  onClick={() => setActiveTab('sametinget')}
